...
<head>
    ...
    <title>Kategori Permasalahan - HealthMind Admin</title>
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-xl transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col">
        ...
        <div class="py-6 overflow-y-auto flex-1">
            ...
            <nav class="space-y-1">
                ...
                <!-- Menu Baru: Kategori Masalah -->
                <a href="#" class="flex items-center space-x-3 px-6 py-3 bg-pink-50 text-pink-600 border-r-4 border-pink-600 transition-colors">
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header class="flex items-center justify-between h-16 px-6 bg-white border-b border-gray-100 shadow-sm shrink-0 z-10">
            <div class="flex items-center">
                ...
                <h1 class="text-xl font-bold text-gray-800 hidden md:block">Master Data: Kategori</h1>
            </div>

            <div class="flex items-center space-x-4">
                <div class="relative hidden md:block">
                     <i data-lucide="search" class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4"></i>
                     <input type="text" placeholder="Cari kategori..." class="pl-10 pr-4 py-2 border border-gray-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-pink-500 w-64 bg-gray-50">
                </div>
                <div class="flex items-center space-x-3 border-l pl-4 border-gray-200">
                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Admin" alt="Profile" class="h-9 w-9 rounded-full border-2 border-pink-100">
                </div>
            </div>
        </header>
                ...
                <div class="mb-4 md:mb-0">
                    <nav class="text-sm mb-1 text-gray-500">
                        <ol class="list-none p-0 inline-flex">
                            <li class="flex items-center"><a href="#" class="hover:text-pink-500">Dashboard</a> <i data-lucide="chevron-right" class="w-4 h-4 mx-2"></i></li>
                            <li class="text-gray-800 font-medium">Kategori Masalah</li>
                        </ol>
                    </nav>
                    <h2 class="text-2xl font-bold text-gray-800">Daftar Topik Permasalahan</h2>
                </div>
                <div class="flex space-x-2 w-full md:w-auto">
                    <button class="flex-1 md:flex-none flex items-center justify-center px-4 py-2 bg-pink-600 text-white rounded-lg hover:bg-pink-700 text-sm shadow-md font-medium transition-all">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm">
                            ...
                            <tr class="hover:bg-pink-50/30 transition-colors">
                                <td class="px-6 py-4 font-mono text-gray-500 text-xs">CAT-01</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                       
                                        <span class="font-bold text-gray-900">Stress & Anxiety</span>
                                    </div>
                                </td>
                            ...
                            <!-- Row 2 -->
                            <tr class="hover:bg-pink-50/30 transition-colors">
                                <td class="px-6 py-4 font-mono text-gray-500 text-xs">CAT-02</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        
                                        <span class="font-bold text-gray-900">Depresi</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end space-x-2">
                            ...
                            <!-- Row 3 -->
                            <tr class="hover:bg-pink-50/30 transition-colors">
                                <td class="px-6 py-4 font-mono text-gray-500 text-xs">CAT-03</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                      
                                        <span class="font-bold text-gray-900">Hubungan & Keluarga</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end space-x-2">
                            ...
                            <!-- Row 4 -->
                            <tr class="hover:bg-pink-50/30 transition-colors">
                                <td class="px-6 py-4 font-mono text-gray-500 text-xs">CAT-04</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                       
                                        <span class="font-bold text-gray-900">Trauma & PTSD</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end space-x-2">
